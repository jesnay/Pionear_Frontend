        ...
        <Carousel interval={null} className="InfoText">
          <Carousel.Item>
            ...
            <p>
              ...
              überlieferte Tradition des
            </p>
          </Carousel.Item>
          <Carousel.Item>
            <p>
              deutschen Minnesanges verschriftlicht. Mehr über diese
              Verschriftlichung, ihren Kontext und die zugrundeliegenden
              Absichten zu erfahren gehört zu den Fragestellungen des
              Sonderforschungsbereichs. Wieso hielten die Sammler der Lieder
              deren Niederschrift plötzlich für notwendig? Schon damals hatten
              die Sammler einen Anspruch auf Vollständigkeit. Heute gilt
            </p>
          </Carousel.Item>
          <Carousel.Item>
            <p>
              der Codex Manesse als die umfangreichste deutsche
          ...
          <Carousel.Item>
            <p>
              ...
              die den Codex heute so berühmt machen. Das Buch hat eine sehr
              ...
              Zusammenhang auch von einer „Reise“ sprechen kann. Nach Heidelberg
            </p>
          </Carousel.Item>
          <Carousel.Item>
            <p>
              kam der Codex Manesse 1607, wo er in die ebenfalls berühmte
              Biblioteca Palatina aufgenommen wurde. Dort blieb er jedoch nur 15
              Jahre, denn 1622 stand während des 30jährigen Krieges die
              katholische Liga vor den Toren Heidelbergs vor der der Codex
              Manesse in Sicherheit gebracht wurde und schließlich über mehrere
              Stationen nach Paris gelangte. Der Rest der Biblioteca Palatina
              wurde als Beute in
            </p>
          </Carousel.Item>
          <Carousel.Item>
            <p>
              den Vatikan gebracht. Anschließend bemühten sich mehrere deutsche
              Herrscher und Fürsten den Codex Manesse zurück nach Heidelberg zu
              bringen, was allerdings erst 1888 gelang. Gerade diese Bemühungen
              zeigen, welch hohes Prestige mit dem Besitz des Buches einherging
              - es erlangte eine Bedeutung über den bloßen immanenten
              Nutzungscharakter – dem Lesen – hinaus.
            </p>
          </Carousel.Item>
        </Carousel>
      </div>
        ...
        <Carousel interval={null} className="InfoText">
          ...
          <Carousel.Item>
            <p>
              ...
              Auffinden von Informationen genutzt werden. Im
            </p>
          </Carousel.Item>
          <Carousel.Item>
            <p>
              Laufe der Zeit wurde der Codex dann zu einem Prestigeobjekt,
              dessen Besitz dem eigenen Ansehen nutzte. Heutzutage bietet sich
              der Codex Manesse als Forschungsobjekt an, das von uns analysiert
              werden kann. Im Rahmen einer Ausstellung wiederum ist seine
              Nutzungsmöglichkeit, Geschichte zu vermitteln. An dieser Stelle
              bot es sich übrigens an, den Codex Manesse zur
            </p>
          </Carousel.Item>
          <Carousel.Item>
            <p>Erklärung des Begriffes der Affordanz zu nutzen.</p>
          </Carousel.Item>
        </Carousel>
      </div>
